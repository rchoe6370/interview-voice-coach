...
export function SessionSummary({ totalScore, overallCategory, conclusion, strengths, growthAreas, questions, retryTargetIndex, certificateUnlocked, onRetry }: SessionSummaryProps) {
  return <section>
    ...
    <button type="button" onClick={onRetry} style={{ padding: "12px 18px", background: "#d94a4a", color: "white", border: 0, borderRadius: 8, fontWeight: 800 }}>Retry weakest answer</button>
  </section>;
}
